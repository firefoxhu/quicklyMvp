...
public class SettingUtil {
    ...
    private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(QuicklyApplication.appContext);
    ...
    public boolean getIsNoPhotoMode() {
        return setting.getBoolean("switch_noPhotoMode", false) && NetWorkUtil.isMobileConnected(QuicklyApplication.appContext);
    }
     ...
     */
    public int getColor() {
        int defaultColor = QuicklyApplication.appContext.getResources().getColor(R.color.colorPrimary);
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetWorkUtil.isWifiConnected(QuicklyApplication.appContext);
    }
